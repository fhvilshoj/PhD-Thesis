...
First, we consider how to improve the performance of generative neural networks, as it has the potential of improving methods for explaining neural networks further downstream.
...
This is in stark contrast to related work, which either needs to do expensive gradient optimizations, which require hundreds of evaluations of the classifier or needs to spend time training an external generative model.
...
Based on our findings, we introduce two new metrics, which mitigates some of the drawbacks of existing metrics. 
