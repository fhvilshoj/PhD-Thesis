...
To make it clear, which sections in Part \ref{part:overview} corresponds to which papers in Part \ref{part:publications}, we have annotated section titles relating directly to specific papers with, \eg,  ``\hspace{-0.5em}\contribution{pap:svd}'' as a shorthand for \paperref{pap:svd}.
...
% 1. Generative models are expensive to train
% 3. Bigger models seem to perform better. 
% 2. Can we train them faster, then we can get bigger models.
% 4. We developed two algorithms for training generative models faster.
% 5. Arguably, better generative models will yield better explanations further down stream.

% EXPLAINING NEURAL NETWORKS
% 1. We demonstrate how to analytically generate  explanations like the one with glare and smoke from above
% 2. ECINN is one of now multiple examples that demonstrate how generative models are very beneficial in terms of explaining neural networks.
% 2. We further the field quantitatively evaluating counterfactual explanations.
